...
FARM_SET_VALID_BOUNDARY_FARM_IMAGE = [
    ...
    "images/farm_images/" + "a" * 80 + ".png"  # Long valid path
]
...
FARM_SET_INVALID_BOUNDARY_FARM_IMAGE = [
    "",  # Empty string
    None,  # None value
    "images/farm_images/" + "a" * 81 + ".png"  # Exceeds typical file path length
]
...
FILERECORD_SET_VALID_BOUNDARY_FILE = [
    ...
    "files/" + "a" * 80 + ".pdf"  # Long valid path
]
...
FILERECORD_SET_INVALID_BOUNDARY_FILE = [
    "",  # Empty string
    None,  # None value
    "files/" + "a" * 81 + ".pdf"  # Exceeds typical file path length
]
...
FARMCONTACTS_SET_BOUNDARY_VALID_IMAGE = [
    ...
    "images/contact_images/" + "a" * 80 + ".png"  # Long valid path
]
...
FARMCONTACTS_SET_BOUNDARY_INVALID_IMAGE = [
    "",  # Empty string
    None,  # None value
    "images/contact_images/" + "a" * 81 + ".png"  # Exceeds typical file path length
]
...
# Valid cases for maintenaceType
MAINTENANCE_VALID_MAINTENACE_TYPE = [
    0,  # Assuming 0 is a valid choice
    1,  # Assuming 1 is a valid choice
    2,  # Assuming 2 is a valid choice
    3,  # Assuming 3 is a valid choice
...
# Invalid cases for maintenaceType
MAINTENANCE_INVALID_MAINTENACE_TYPE = [
    None,  # None value
    -1,  # Negative value
    5,  # Assuming 5 is not a valid choice
    "invalid",  # Non-integer value
...
# Boundary valid cases for maintenaceType
MAINTENANCE_BOUNDARY_VALID_MAINTENACE_TYPE = [
    0,  # Minimum valid choice
    4,  # Maximum valid choice
]

# Boundary invalid cases for maintenaceType
MAINTENANCE_BOUNDARY_INVALID_MAINTENACE_TYPE = [
    -1,  # Negative value
    5,  # Exceeds maximum valid choice
]
...
if __name__ == "__main__":
    ...
    generate_dataset_from_model(model, True, True, False)
