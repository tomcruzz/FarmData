...
class orgSettingsForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ['timezone', 'datetime_format', 
                  'temperature_label', 'mass_label', 
                  'area_label', 'length_label']
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
"""
The following section is used to define forms related to the 'internalTeams' model.
"""
...
class teamSettingsForm(ModelForm):
    ...
    userList = forms.ModelMultipleChoiceField(queryset=UserProfile.objects.none(),
...
class userDetailsForm(ModelForm):
    ...
    groups = forms.ModelMultipleChoiceField(queryset=SecurityGroup.objects.all(),
                                            widget=forms.CheckboxSelectMultiple, 
